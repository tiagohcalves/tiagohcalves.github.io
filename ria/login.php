<?php
	if($_SESSION["logado_ria"] == 1){
		header('Location: http://tiagohca.com/ria/index.php');
	}
	if(isset($_POST["senha"]) && $_POST["senha"] == "chiquinho"){
		session_start();
		$_SESSION["logado_ria"] = 1;
		header('Location: http://tiagohca.com/ria/index.php');
	}
?>
...
<div id="loginModal" class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-content">
      <div class="modal-header">
          <h1 class="text-center">Não Ria!</h1>
      </div>
